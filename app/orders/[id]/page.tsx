    ...
    <div className="bg-[#f5f5f7] min-h-screen pt-12 pb-24">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl">
          ...
          <span className={`inline-block mt-4 px-3 py-1 text-[10px] font-bold tracking-widest uppercase ${
        ...
        <div className="mt-10 flex justify-end">
          <Link href="/products" className="bg-[#0071e3] text-white px-8 py-4 text-xs font-bold tracking-widest uppercase hover:bg-[#0077ed] transition-colors rounded-full">
            Continue Shopping
          </Link>
        </div>
      </main>
